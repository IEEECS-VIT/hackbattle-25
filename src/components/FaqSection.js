...
export default function FaqSection() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      characterStyle: {
        transform: "translateY(100px) translateX(20px) scale(2.0)",
      },
    },
    {
      ...
      characterWebM: "/Piglin.gif",
      characterStyle: {
        transform: "translateY(170px) translateX(-40px) scale(1.2)",
      },
    },
    {
      ...
      characterStyle: {
        transform: "translateY(155px) translateX(-50px) scale(1.2)",
      },
    },
  ];
          ...
          <div className="hidden md:flex md:w-1/3 md:items-end md:justify-center">
            <div className="w-full mt-35">
              ...
              <CharacterDisplay 
                ...
                className={displayedCharacter.src === '/Blaze.gif' ? 'transform scale-x-[-1]' : ''}
              />
            </div>
          </div>
