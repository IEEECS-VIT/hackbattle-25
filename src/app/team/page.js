  ...
  return (
    <>
      ...
      <main className="relative w-full h-full flex flex-col items-center justify-center overflow-hidden">
        ...
        {/* Top Nav for Desktop */}
        <div className="absolute z-20 p-4 flex justify-between items-start w-full top-4 md:top-4 hidden sm:flex">
          <button
            onClick={() => router.push("/")}
        ...
        <div className="text-center text-white px-4 w-full h-full mt-24 md:mt-12">
          ...
          {/* Mobile Buttons: Leave + Submission */}
          <div className="flex justify-center gap-4 sm:hidden mb-6">
            <button
              onClick={handleLeaveTeam}
            ...
            <button
              onClick={handleSubmissionClick}
              className="bg-pink-500/70 hover:bg-pink-500/90 text-white px-6 py-2 rounded-lg shadow-lg"
            >
              Submission
            </button>
          </div>
